...
before the subject, as shown in \ex{1} and \ex{2}.

\enumsentence{Will John buy a backpack?}
\enumsentence{What will John buy?}
...
\enumsentence{John bought a backpack .}
\enumsentence{$\ast$Bought John a backpack ?}
\enumsentence{Did John buy a packpack ?}

\enumsentence{$\ast$John bought not a backpack .}
\enumsentence{$\ast$John not bought a backpack .}
\enumsentence{John did not buy a backpack .}
...
\enumsentence{Jerry {\bf dared} not eat the strawberries .}
\enumsentence{only models {\bf dare} wear such extraordinary outfits .}
\enumsentence{{\bf dare} Dale tell Mary the secret ?}
...
\enumsentence{Biff {\bf ought} to have been working tonight .}
\enumsentence{$\ast$Carson does {\bf ought} to have been working tonight .}
\enumsentence{the party {\bf is} to take place tonight .}
\enumsentence{$\ast$the party had {\bf been} to take place tonight .}
...
\enumsentence{The party cannot possibly {\it be about to} begin just yet .}
\enumsentence{Miranda {\it is about to} steal the gun .}
\enumsentence{I consider Miranda {\it about to} be upset .}
...
rule out examples like \ex{1} and \ex{2}:

\enumsentence{??John seems about to leave .}
\enumsentence{*Mary could about to solve the problem .}

{\it Seems} is a raising verb that can select for VP's which have {\bf
...
%
} We are able to rule \ex{-1} out because of the special status of raising
...
$\beta$Vvx-arb tree, as illustrated in \ex{0} above, we have an additional
