...
foreach $file (@ARGV) {
	...
	s#\\begin[ ]*{figure[\*]*}.*$#\\begin{rawhtml} <p> \\end{rawhtml}#;
	s#\\end[ ]*{figure[\*]*}.*$#\\begin{rawhtml} <p> \\end{rawhtml}#;
	m#\\caption[ ]*(.*)$#;
        $newcaption = $1;
        $newcaption =~ s/\{\\it//g;
        $newcaption =~ s/\{\\bf//g;
        $newcaption =~ s/\{\\em//g;
        $newcaption =~ s/\}//g;
	s#\\caption[ ]*.*$}#\\begin{rawhtml} <dl> <dt>$newcaption<p> </dl> \\end{rawhtml}#;
