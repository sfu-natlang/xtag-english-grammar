...
\beginsentences
\sitem{how many and which people camp frequently ?}\label{ex:116} 
\sitem{$^*$some or which people enjoy nature .}\label{ex:117} 
\endsentences
...
\beginsentences
\sitem{So it is too with many other spirits which we all know: the spirit of Nazism or Communism, school spirit , the spirit of a street corner gang or a football team, the spirit of Rotary or the Ku Klux Klan. \hfill [Brown cd01]}\label{ex:118} 
\endsentences
...
We are analyzing conjoined structures such as {\it The women but not the men} with a multi-anchor conjunction tree anchored by the 
...
\beginsentences
\sitem{Beth grows basil in the house (but) not in the garden .}\label{ex:119} 
\sitem{$^*$Beth grows basil (but) not in the garden .}\label{ex:120} 
\endsentences
...
\beginsentences
\sitem{two to three degrees}\label{ex:121} 
\sitem{high to very high temperatures}\label{ex:122} 
\endsentences
...
\beginsentences
\sitem{(((Harry cooked) and (Mary ate)) the beans that I bought   from Alice)}\label{ex:123} 
\endsentences
...
\begin{rawhtml} <p> \end{rawhtml}
  \begin{center} 
    \leavevmode 
    \htmladdimg{ps/conj-files/conj.ps.gif} 
  \end{center} 
...
\beginsentences
\sitem{$\ldots$ eats cookies and drinks beer}\label{ex:124} 
\endsentences
...
\begin{rawhtml} <p> \end{rawhtml}
  \begin{center} 
    \leavevmode 
    \htmladdimg{ps/conj-files/vpc.ps.gif} 
  \end{center} 
...
\begin{rawhtml} <p> \end{rawhtml}
  \begin{center} 
    \leavevmode 
    \htmladdimg{ps/conj-files/aux-conj.ps.gif} 
  \end{center} 
...
\beginsentences
\sitem{$\ast$He tried and came yesterday.}\label{ex:125} 
\sitem{They try and exercise three times a week.}\label{ex:126} 
\sitem{He wants to try and sell the puppies.}\label{ex:127} 
\endsentences
...
%phrase conjunction.  For example, in the sentence {\it John eats cookies and %drinks beer}, there is no point in the derivation at which {\it eats cookies} 
