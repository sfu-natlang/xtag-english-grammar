...
\beginsentences
\sitem{The music should have been being played [for the president] .}\label{ex:1} 
\endsentences
...
%  the right page. 
\footnotetext{There are American dialects, particularly in the South, which allow double modals such as {\it might could} and {\it might should}. These constructions are not allowed in the XTAG English grammar.} 
...
\beginsentences
\sitem{John does not want a car .}\label{ex:2} 
\sitem{$\ast$John not wants a car .}\label{ex:3} 
\sitem{John will not want a car .}\label{ex:4} 
\sitem{Do you want to leave home ?}\label{ex:5} 
\sitem{$\ast$want you to leave home ?}\label{ex:6} 
\sitem{will you want to leave home ?}\label{ex:7} 
\endsentences
...
\beginsentences
\sitem{$\ast$We will have do bought a sleeping bag .}\label{ex:8} 
\sitem{$\ast$We do will have bought a sleeping bag .}\label{ex:9} 
\sitem{You {\bf do} have a backpack, don't you ?}\label{ex:10} 
\sitem{I {\bf do} want to go !}\label{ex:11} 
\sitem{$\ast$You {\bf do} can have a backpack, don't you ?}\label{ex:12} 
\sitem{$\ast$I {\bf did} have had a backpack !}\label{ex:13} 
\endsentences
...
\beginsentences
\sitem{John will have had a backpack .}\label{ex:14} 
\sitem{$\ast$John not will have had a backpack .}\label{ex:15} 
\sitem{John will not have had a backpack .}\label{ex:16} 
\sitem{John will have not had a backpack .}\label{ex:17} 
\endsentences
...
\beginsentences
\sitem{do you want to leave home ?}\label{ex:18} 
\sitem{$\ast$want you to leave home ?}\label{ex:19} 
\sitem{will you want to leave home ?}\label{ex:20} 
\sitem{$\ast$do you will want to leave home ?}\label{ex:21} 
\endsentences
...
\beginsentences
\sitem{John wants to have a backpack .}\label{ex:22} 
\sitem{John wants Mary to have a backpack .}\label{ex:23} 
\sitem{John wants for Mary to have a backpack .}\label{ex:24} 
\endsentences
...
\beginsentences
\sitem{she {\bf dare} not have been seen .}\label{ex:25} 
\sitem{she does not {\bf dare} succeed .}\label{ex:26} 
\sitem{Jerry {\bf dared} not eat the strawberries .}\label{ex:27} 
\sitem{only models {\bf dare} wear such extraordinary outfits .}\label{ex:28} 
\sitem{{\bf dare} Dale tell Mary the secret ?}\label{ex:29} 
\sitem{$\ast$Louise had dared not tell a soul .}\label{ex:30} 
\endsentences
...
\beginsentences
\sitem{Alex {\bf used} to attend karate workshops .}\label{ex:31} 
\sitem{Angelina might have {\bf used} to believe in fate .}\label{ex:32} 
\sitem{Rich did not {\bf used} to want to be a physical therapist .}\label{ex:33} 
\sitem{Mick might not {\bf have} to play the game tonight .}\label{ex:34} 
\sitem{Singer {\bf had} to have been there .}\label{ex:35} 
\sitem{Heather has {\bf got} to finish that project before she goes insane .}\label{ex:36} 
\endsentences
...
\beginsentences
\sitem{Biff {\bf ought} to have been working tonight .}\label{ex:37} 
\sitem{$\ast$Carson does {\bf ought} to have been working tonight .}\label{ex:38} 
\sitem{the party {\bf is} to take place tonight .}\label{ex:39} 
\sitem{$\ast$the party had {\bf been} to take place tonight .}\label{ex:40} 
\endsentences
...
\beginsentences
\sitem{the miller {\bf cans} tell a good story .  (vs  the farmer {\bf cans} peaches in July .)}\label{ex:41} 
\sitem{David {\bf wills} have finished by noon .  (vs  the old man {\bf wills} his fortune to me .)}\label{ex:42} 
\sitem{Sarah {\bf needs} not leave .  (vs  Sarah {\bf needs} to leave .)}\label{ex:43} 
\sitem{Jennifer {\bf dares} not be seen .  (vs  the young woman {\bf dares} him to do the stunt .)}\label{ex:44} 
\sitem{Lila {\bf does use} to like beans .  (vs  Lila {\bf does use} her new cookware .)}\label{ex:45} 
\endsentences
