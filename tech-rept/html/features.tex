...
\beginsentences
\sitem{ {\bf NP$_{subj}$:$\langle$agr$\rangle =$ VP.t:$\langle$agr$\rangle$}}\label{ex:192} 
\endsentences

 
 
\beginsentences
\sitem{ {\bf VP.b:$\langle$agr$\rangle =$ V.t:$\langle$agr$\rangle$}}\label{ex:193} 
\endsentences
...
\beginsentences
\sitem{ \ [Which boys]$_{i}$ does John think [t$_{i}$ are/*is intelligent]?}\label{ex:194} 
\endsentences
...
\beginsentences
\sitem{ {\bf PP.b:$\langle$assign-case$\rangle =$ P.t:$\langle$case$\rangle$}}\label{ex:195} 
\endsentences

 
 
\beginsentences
\sitem{ {\bf NP.t:$\langle$case$\rangle =$ P.t:$\langle$case$\rangle$}}\label{ex:196} 
\endsentences
...
\beginsentences
\sitem{ {\bf P.b:$\langle$assign-case$\rangle =$ acc}}\label{ex:197} 
\endsentences
...
\beginsentences
\sitem{ {\bf NP$_{object}$.t:$\langle$case$\rangle =$ acc}}\label{ex:198} 
\endsentences
...
\beginsentences
\sitem{ {\bf NP$_{subj}$:$\langle$case$\rangle =$ VP.t:$\langle$assign-case$\rangle$}}\label{ex:199} 
\endsentences

 
 
\beginsentences
\sitem{ {\bf VP.b:$\langle$assign-case$\rangle =$ V.t:$\langle$assign-case$\rangle$}}\label{ex:200} 
\endsentences
...
\beginsentences
\sitem{ Her$_{i}$/*She$_{i}$, I think that Odo like t$_{i}$.}\label{ex:201} 
\endsentences
...
\beginsentences
\sitem{ * John wants [Bill$_{i}$ [PRO to leave t$_{i}$]] }\label{ex:202} 
\endsentences
...
\beginsentences
\sitem{ {\bf S$_{q}$.b:$\langle$wh$\rangle =$ NP.t:$\langle$wh$\rangle$}\label{inv1}}\label{ex:203} 
\sitem{ {\bf S$_{q}$.b:$\langle$invlink$\rangle =$  S$_{q}$.b:$\langle$inv$\rangle$}\label{inv2}}\label{ex:204} 
\sitem{ {\bf S$_{q}$.b:$\langle$inv$\rangle =$  S$_{r}$.t:$\langle$inv$\rangle$}\label{inv3}}\label{ex:205} 
\sitem{ {\bf S$_{r}$.b:$\langle$inv$\rangle = -$}\label{inv4}}\label{ex:206} 
\endsentences
...
\beginsentences
\sitem{ Who$_{i}$ does Loida think [Miguel likes t$_{i}$]}\label{ex:207} 
\endsentences
...
%triggered using the {\bf $\langle$invlink$\rangle$}, {\bf %$\langle$inv$\rangle$}, {\bf $\langle$wh$\rangle$} features. Inversion 
...
%which is used to simulate Multi-Component TAGs.\footnote{The {\bf %$\langle$displ-const$\rangle$} feature is also used in the ECM %analysis.} The sub-value {\bf set1} indicates the inversion 
...
\beginsentences
\sitem{  {\bf S$_{r}$.b:$\langle$displ-const set1$\rangle = -$}\label{dis1}}\label{ex:208} 
\sitem{  {\bf S.t:$\langle$displ-const set1$\rangle = +$}\label{dis2}}\label{ex:209} 
\sitem{  {\bf VP.b:$\langle$displ-const set1$\rangle =$           V.t:$\langle$displ-const set1$\rangle$}\label{dis3}}\label{ex:210} 
\sitem{  {\bf V.b:$\langle$displ-const set1$\rangle = +$}\label{dis4}}\label{ex:211} 
\sitem{  {\bf S$_{r}$.b:$\langle$displ-const set1$\rangle =$           VP.t:$\langle$displ-const set1$\rangle$}\label{dis5}}\label{ex:212} 
\endsentences

 
 
\section{Clause Type} 
There are several features that mark clause type.\footnote{We have already seen one instance of a feature that marks clause-type: {\bf $\langle$extracted$\rangle$}, which marks whether a certain S involves extraction or not.} They are:\\ {\bf $\langle$mode$\rangle$}\\ 
...
predicative trees headed by a null copula.  {\bf prep} is the {\bf $\langle$mode$\rangle$} value of PP predicative trees headed by a null 
...
\beginsentences
\sitem{ {\bf VP$_{r}$.b:$\langle$mode$\rangle =$           V.t:$\langle$mode$\rangle$}\label{mode1}}\label{ex:213} 
\sitem{ {\bf  V.t:$\langle$mode$\rangle =$ base}\label{mode2}}\label{ex:214} 
\sitem{ {\bf VP.b:$\langle$mode$\rangle =$ ppart}\label{mode3}}\label{ex:215} 
\endsentences
...
nodes have {\bf ppart} as the value of their {\bf $\langle$mode$\rangle$} feature. There are two such trees -- the {\em be} tree and the {\em have} tree. The {\em be} tree is fine because 
its foot node has {\bf +} as its {\bf $\langle$passive$\rangle$} 
feature, so both the {\bf $\langle$passive$\rangle$} and {\bf $\langle$mode$\rangle$} values unify; the {\em have} tree is blocked 
because its foot node has {\bf --} as its {\bf $\langle$passive$\rangle$} feature. 
...
\beginsentences
\sitem{ {\bf Comp.t:$\langle$select-mode$\rangle =$ S$_{t}$.t:$\langle$mode$\rangle$}}\label{ex:216} 
\endsentences
...
\beginsentences
\sitem{ {\bf S$_{r}$.t:$\langle$rel-pron$\rangle =$ Comp.t:$\langle$rel-pron$\rangle$}}\label{ex:217} 
\sitem{ {\bf S$_{r}$.b:$\langle$rel-pron$\rangle =$ S$_{r}$.b:$\langle$mode$\rangle$}}\label{ex:218} 
\sitem{ {\bf Comp.b:$\langle$rel-pron$\rangle =$ppart/ger/adj-clause} (for $\epsilon$$_{C}$)}\label{ex:219} 
\endsentences
...
\beginsentences
\sitem{ the toy [$\epsilon$$_{i}$ [$\epsilon$$_{C}$ [ Dafna likes t$_{i}$ ]]] }\label{ex:220} 
\endsentences
...
\beginsentences
\sitem{ {\bf S$_{m}$.b:$\langle$rel-pron$\rangle =$ S$_{f}$.t:$\langle$rel-pron$\rangle$}}\label{ex:221} 
\endsentences
...
\beginsentences
\sitem{ On the root of the RC: {\bf NP$_{r}$.b:$\langle$rel-clause$\rangle = +$}}\label{ex:222} 
\sitem{ On the foot node of the Determiner tree: {\bf NP$_{f}$.t:$\langle$rel-clause$\rangle = -$}}\label{ex:223} 
\endsentences
...
\beginsentences
\sitem{ {\bf S$_{c}$.b:$\langle$comp$\rangle =$ Comp.t:$\langle$comp$\rangle$} }\label{ex:224} 
\sitem{ {\bf S$_{c}$.b:$\langle$wh$\rangle =$ Comp.t:$\langle$wh$\rangle$}}\label{ex:225} 
\sitem{ {\bf S$_{c}$.b:$\langle$mode$\rangle =$ ind/sbjnct}}\label{ex:226} 
\sitem{ {\bf S$_{r}$.t:$\langle$assign-comp$\rangle =$ Comp.t:$\langle$comp$\rangle$}}\label{ex:227} 
\sitem{ {\bf S$_{r}$.b:$\langle$comp$\rangle =$ nil}}\label{ex:228} 
\endsentences
...
\beginsentences
\sitem{ {\bf S$_{1}$.t:$\langle$comp$\rangle =$ that/whether/if/nil}}\label{ex:229} 
\sitem{{\bf S$_{1}$.t:$\langle$mode$\rangle =$ ind/sbjnct} or {\bf S$_{1}$.t:$\langle$mode$\rangle =$ ind}}\label{ex:230} 
\sitem{ {\bf S$_{1}$.t:$\langle$assign-comp$\rangle =$ ind\_nil/inf\_nil}}\label{ex:231} 
\endsentences
...
\beginsentences
\sitem{ {\bf S$_{1}$.t:$\langle$comp$\rangle =$ nil}}\label{ex:232} 
\sitem{ {\bf S$_{1}$.t:$\langle$mode$\rangle =$ inf}}\label{ex:233} 
\sitem{ {\bf S$_{1}$.t:$\langle$assign-comp$\rangle =$ ind\_nil/inf\_nil} }\label{ex:234} 
\endsentences
...
\beginsentences
\sitem{ {\bf S$_{1}$.t:$\langle$comp$\rangle =$ for/nil}}\label{ex:235} 
\sitem{ {\bf S$_{1}$.t:$\langle$mode$\rangle =$ inf}}\label{ex:236} 
\sitem{ {\bf S$_{1}$.t:$\langle$assign-comp$\rangle =$ ind\_nil/inf\_nil}}\label{ex:237} 
\endsentences
...
\beginsentences
\sitem{ {\bf S$_{1}$.t:$\langle$comp$\rangle =$ nil}}\label{ex:238} 
\sitem{ {\bf S$_{1}$.t:$\langle$mode$\rangle =$ inf}}\label{ex:239} 
\sitem{ {\bf S$_{1}$.t:$\langle$assign-comp$\rangle =$ ecm}}\label{ex:240} 
\endsentences
...
\beginsentences
\sitem{ *(That) John is crazy is likely.}\label{ex:241} 
\endsentences
...
\beginsentences
\sitem{ {\bf S$_{0}$.t:$\langle$comp$\rangle =$ that/whether/for/nil}}\label{ex:242} 
\sitem{ {\bf S$_{0}$.t:$\langle$mode$\rangle =$ inf/ind}}\label{ex:243} 
\sitem{ {\bf S$_{0}$.t:$\langle$assign-comp$\rangle =$ inf\_nil}}\label{ex:244} 
\endsentences
...
\beginsentences
\sitem{ Who$_{i}$ do you think (*that) t$_{i}$ ate the apple?}\label{ex:245} 
\endsentences
...
\beginsentences
\sitem{ {\bf S$_{r}$.b:$\langle$assign-comp$\rangle =$ inf\_nil/ind\_nil/ecm}}\label{ex:246} 
\endsentences
...
\beginsentences
\sitem{ Who$_{i}$ do you want [ t$_{i}$ to win the World Cup]?}\label{ex:247} 
\sitem{ Who$_{i}$ do you consider [ t$_{i}$ intelligent]?}\label{ex:248} 
\endsentences
...
\beginsentences
\sitem{ S$_{r}$.t:$\langle$conj$\rangle$ = disc}\label{ex:249} 
\sitem{ S$_{c}$.b:$\langle$conj$\rangle$ = and/or/but/nil}\label{ex:250} 
\endsentences
...
\beginsentences
\sitem{ NP$_{1}$.t:$\langle$pred$\rangle$ = +}\label{ex:251} 
\sitem{ NP$_{1}$.b:$\langle$pred$\rangle$ = +}\label{ex:252} 
\sitem{ NP.t:$\langle$pred$\rangle$ = +}\label{ex:253} 
\sitem{ N.t:$\langle$pred$\rangle$ = NP.b:$\langle$pred$\rangle$}\label{ex:254} 
\endsentences
...
\beginsentences
\sitem{ AdvP$_{1}$.t:$\langle$pred$\rangle$ = +}\label{ex:255} 
\sitem{ AdvP$_{1}$.b:$\langle$pred$\rangle$ = +}\label{ex:256} 
\sitem{ NP.t:$\langle$pred$\rangle$ = +}\label{ex:257} 
\sitem{ AdvP.b:$\langle$pred$\rangle$ = NP.t:$\langle$pred$\rangle$}\label{ex:258} 
\endsentences
...
\beginsentences
\sitem{ {\bf S$_{r}$.b:$\langle$tense$\rangle$ = VP.t:$\langle$tense$\rangle$}}\label{ex:259} 
\sitem{ {\bf VP.b:$\langle$tense$\rangle$ = V.t:$\langle$tense$\rangle$}}\label{ex:260} 
\endsentences
