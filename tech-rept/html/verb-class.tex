...
\section{Multiple anchor ditransitive with PP: Tnx0Vnx1Pnx2}\index{verbs, multi-anchor ditransitive verbs} 
\label{nx0Vnx1Pnx2-family} 
...
% 
% \section{Ditransitive with PP shift: Tnx0Vnx1tonx2}\index{verbs,ditransitive % with PP shift} 
% \label{nx0Vnx1Pnx2-family} 
% 
% \begin{description} 
% 
...
% (a) && (b) 
% \end{tabular} 
% \begin{rawhtml} <dl> <dt>{Declarative Ditransitive with PP shift Trees: $\alpha$nx0Vnx1Pnx2~(a) % and $\alpha$nx0Vnx2nx1~(b) <p> </dl> \end{rawhtml}
% \label{nx0Vnx1Pnx2-tree} 
% \begin{rawhtml} <p> \end{rawhtml}
% 
...
\section{Sentential Complement with NP: Tnx0Vnx1s2}\index{verbs,Sentential Complement with NP} 
...
%%\centering 
%%\begin{tabular}{cc} 
%%\htmladdimg{ps/verb-class-files/betanx0N1s2.ps.gif} & 
%%psfig{figure=ps/verb-class-files/betanx0dxN1s2.ps,height=4.0cm} \\ 
%%$\beta$nx0N1s2 &$\beta$nx0dxN1s2 
%%\end{tabular} 
%%\begin{rawhtml} <dl> <dt>{Declarative NP Small Clauses with Sentential Complement Tree <p> </dl> \end{rawhtml}
%%\label{nx0N1s2-tree} 
%%\begin{rawhtml} <p> \end{rawhtml}
%% 
...
\section{Sentential Subject with `to' complement:  Ts0Vtonx1}\index{verbs,sentential subject, PP complement} 
...
%  complement. This tree family is selected by {\it likely} and {\it     certain}. 
...
%\centering 
%\begin{tabular}{c} 
%\htmladdimg{ps/verb-class-files/alphas0A1s1.ps.gif} 
%\end{tabular} 
%\begin{rawhtml} <dl> <dt>{Predicative Adjective with Sentential Subject and Complement: %$\alpha$s0A1s1 <p> </dl> \end{rawhtml}
%\label{s0A1s1-tree} 
%\begin{rawhtml} <p> \end{rawhtml}
...
%%\centering 
%%\begin{tabular}{c} 
%%\htmladdimg{ps/verb-class-files/alpha???.ps.gif} 
%%\end{tabular} 
%%\begin{rawhtml} <dl> <dt>{Declarative Transitive Tree:  $\alpha$nx0Vnx1 <p> </dl> \end{rawhtml}
%%\label{decl-????-tree} 
%%\begin{rawhtml} <p> \end{rawhtml}
