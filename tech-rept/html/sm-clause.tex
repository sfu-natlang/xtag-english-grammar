...
\beginsentences
\sitem{Carl is a jerk .}\label{ex:579} 
\sitem{Carl is upset .}\label{ex:580} 
\sitem{Carl is in a foul mood .}\label{ex:581} 
\endsentences
...
\beginsentences
\sitem{is Beth writing her dissertation ?\\ 		is Beth upset ?\\ 		$\ast$wrote Beth her dissertation ?}\label{ex:582} 
\endsentences

 
\item Copula {\it be} occurs to the left of the negative marker {\it not}. 
\beginsentences
\sitem{Beth is not writing her dissertation .\\ 		Beth is not upset .\\ 		$\ast$Beth wrote not her dissertation .}\label{ex:583} 
\endsentences

 
\item Copula {\it be} can contract with the negative marker {\it not}. 
\beginsentences
\sitem{Beth isn't writing her dissertation .\\ 		Beth isn't upset .\\ 		$\ast$Beth wroten't her dissertation .}\label{ex:584} 
\endsentences

 
\item Copula {\it be} can contract with pronominal subjects. 
\beginsentences
\sitem{She's writing her dissertation .\\ 		She's upset .\\ 		$\ast$She'ote her dissertation .}\label{ex:585} 
\endsentences

 
\item Copula {\it be} occurs to the left of adverbs in the unmarked order. 
\beginsentences
\sitem{Beth is often writing her dissertation .\\ 		Beth is often upset .\\ 		$\ast$Beth wrote often her dissertation .}\label{ex:586} 
\endsentences
...
\beginsentences
\sitem{The bartender was garrulous .}\label{ex:587} 
\sitem{?The cliff was garrulous .}\label{ex:588} 
\endsentences
...
\beginsentences
\sitem{Carl seems a jerk .\\ 		Carl seems upset .\\ 		Carl seems in a foul mood .}\label{ex:589} 
\endsentences

 
\beginsentences
\sitem{Carl appears a jerk .\\ 		Carl appears upset .\\ 		Carl appears in a foul mood .}\label{ex:590} 
\endsentences
...
\beginsentences
\sitem{Carl seems to be a jerk .\\ 		Carl seems to be upset .\\ 		Carl seems to be in a foul mood .}\label{ex:591} 
\endsentences

 
\beginsentences
\sitem{$\ast$seems Carl to be a jerk ?\\ 		$\ast$Carl seemn't to be upset .\\ 		$\ast$Carl`ems to be in a foul mood .}\label{ex:592} 
\endsentences

 
\beginsentences
\sitem{Carl often seems to be upset .\\ 		$\ast$Carl seems often to be upset .}\label{ex:593} 
\endsentences
...
\beginsentences
\sitem{I consider [Carl a jerk] .\\ 		I consider [Carl upset] .\\ 		?I consider [Carl in a foul mood] .}\label{ex:594} 
\endsentences

 
\beginsentences
\sitem{I prefer [Carl in a foul mood] .\\ 		??I prefer [Carl upset] .}\label{ex:595} 
\endsentences
...
\beginsentences
\sitem{Carl is likely to be a jerk .\\ 		Carl is likely to be upset .\\ 		Carl is likely to be in a foul mood .\\                 Carl is likely to perjure himself .}\label{ex:596} 
\endsentences

 
\beginsentences
\sitem{I consider Carl likely to perjure himself .}\label{ex:597} 
\endsentences
...
\beginsentences
\sitem{John$_{i}$ is [$_{AgrP}$ $t_{i}$ the culprit ] .}\label{ex:598} 
\sitem{The culprit$_{i}$ is [$_{AgrP}$ John $t_{i}$ ] .}\label{ex:599} 
\sitem{I consider [$_{AgrP}$ John the culprit] .}\label{ex:600} 
\sitem{I consider [John$_{i}$ to be [$_{AgrP}$ $t_{i}$ the culprit ]] .}\label{ex:601} 
\sitem{I consider [the culprit$_{i}$ to be [$_{AgrP}$ John $t_{i}$ ]] .}\label{ex:602} 
\endsentences
...
\beginsentences
\sitem{She considers Carl a jerk .\\ 		?She considers Carl in a foul mood .\\ 		$\ast$She considers that Carl is a jerk .}\label{ex:606} 
\endsentences

 
\beginsentences
\sitem{$\ast$She prefers Carl a jerk .\\ 		She prefers Carl in a foul mood .\\ 		She prefers that Carl is a jerk .}\label{ex:607} 
\endsentences

 
\beginsentences
\sitem{$\ast$She feels Carl a jerk .\\ 		$\ast$She feels Carl in a foul mood .\\ 		She feels that Carl is a jerk .}\label{ex:608} 
\endsentences
...
\beginsentences
\sitem{Bob was expected to talk .}\label{ex:609} 
\endsentences
...
\beginsentences
\sitem{Bob was expected by Bill to talk .}\label{ex:610} 
\sitem{Bob was expected to talk by Bill .}\label{ex:611} 
\endsentences
...
\beginsentences
\sitem{Bob sees the harmonica fall .}\label{ex:612} 
\sitem{The harmonica was seen to fall .}\label{ex:613} 
\sitem{$\ast$The harmonica was seen fall .}\label{ex:614} 
\endsentences
...
\beginsentences
\sitem{John is said to be a crook .}\label{ex:615} 
\endsentences
...
\beginsentences
\sitem{John is considered a crook .}\label{ex:616} 
\sitem{The Americans are believed involved in the coup .}\label{ex:617} 
\sitem{$\ast$They believe the Americans involved in the coup .}\label{ex:618} 
\endsentences
...
\beginsentences
\sitem{my teacher is Mrs. Wayman .}\label{ex:619} 
\sitem{Doug is the man with the glasses .}\label{ex:620} 
\endsentences

 
\beginsentences
\sitem{$\ast$My teacher seems Mrs. Wayman .}\label{ex:621} 
\sitem{$\ast$Doug appears the man with the glasses .}\label{ex:622} 
\endsentences

 
\beginsentences
\sitem{$\ast$I consider [my teacher Mrs. Wayman] .}\label{ex:623} 
\sitem{$\ast$I prefer [Doug the man with the glasses] .}\label{ex:624} 
\endsentences
...
\beginsentences
\sitem{The man with the glasses is Doug .}\label{ex:625} 
\sitem{Doug is a programmer .}\label{ex:626} 
\sitem{$\ast$A programmer is Doug .}\label{ex:627} 
\endsentences
...
%%and non-predicative {\it be}.  The sentences in ({\ref{ex:628}}) contain predicative 
%%{\it be} as evidenced by the ungrammaticality of switching the subject {\it the %%challenger} with the clause {\it to provide a non-stipulative solution}. In 
%%contrast the grammaticality of the sentence produced by the equivalent switch 
%%in ({\ref{ex:629}}) shows that the {\it be} in those sentences is 
...
%% 
%%\enumsentence{The challenger is to provide a non-stipulative solution .\\ %%$\ast$To provide a non-stipulative solution is the challenger .\\ %%What$_{i}$ is the challenger to provide $t_{i}$ ?} 
%% 
%%\enumsentence{The challenge is to provide a non-stipulative solution .\\ %%To provide a non-stipulative solution is the challenge .\\ %%		$\ast$What$_{i}$ is the challenge to provide $t_{i}$ ?} 
%% 
%%The ungrammaticality of the extracted NP in ({\ref{ex:627}}) is explained if the 
...
%%equative {\it be}.  In contrast, the predicative {\it be} in ({\ref{ex:626}}) 
%%adjoins to {\it What$_{i}$ the challenger to provide %%$\epsilon_{i}$}\footnote{The elementary tree underlying this sentence would not %%include the infinitive {\it to}.  Since the details of how {\it to} is adjoined %%do not affect the thrust of the current argument, we assume a stage of %%derivation where {\it to} has already been adjoined.}. Since the extraction is 
...
\centering 
\begin{tabular}{ccc} 
{\htmladdimg{ps/sm-clause-files/alphanx0BEnx1_is.ps.gif}} & 
\hspace{1.0in}& 
{\htmladdimg{ps/sm-clause-files/alphaInvnx0BEnx1_is.ps.gif}} \\ 
(a)&&(b)\\ 
\end{tabular} 
\begin{rawhtml} <dl> <dt>{Equative  BE trees: $\alpha$nx0BEnx1 (a) and $\alpha$Invnx0BEnx1 (b) <p> </dl> \end{rawhtml}
\label{equative-be} 
\label{1;1,6} 
\begin{rawhtml} <p> \end{rawhtml}
...
\beginsentences
\sitem{is my teacher Mrs. Wayman ?}\label{ex:628} 
\sitem{Doug isn't the man with the glasses .}\label{ex:629} 
\endsentences
