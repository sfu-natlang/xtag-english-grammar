...
\beginsentences
\sitem{it was [$_{XP}$ here $_{XP}$] [$_{S}$ that the ENIAC was created . $_{S}$]}\label{ex:325} 
\sitem{it was [$_{XP}$ at MIT $_{XP}$]  [$_{S}$ that colorless green ideas slept furiously . $_{S}$]}\label{ex:326} 
\sitem{it is [$_{XP}$ happily $_{XP}$]  [$_{S}$ that Seth quit Reality . $_{S}$]}\label{ex:327} 
\sitem{it was  [$_{XP}$ there $_{XP}$]  [$_{S}$ that she would have to enact her renunciation . $_{S}$]}\label{ex:328} 
\endsentences
...
\beginsentences
\sitem{was it in the forest that the wolf talked to the little girl ?}\label{ex:329} 
\endsentences
