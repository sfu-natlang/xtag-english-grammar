...
\psfig{figure=ps/verb-class-files/alphanx0lVnx2N1.ps,height=4.5cm} \\
(a) & (b) \\%\vspace*{1.2cm}\\
\end{tabular}
...
\section{Resultatives with V (transitive and intransitive), A anchors: TRnx0Vnx1A2}\index{result-verbs-transitive-A}
\label{tr-result_A}
...
\section{Resultatives with V (transitive and intransitive), P anchors: TRnx0Vnx1Pnx2}\index{result-verbs-transitive-P}
\label{tr-result_P}
...
\section{Resultatives with V (ergative), A anchors: TREnx1VA2}\index{verbs-result-erg-A}
\label{E-result_A}
...
\section{Resultatives with V (ergative), P anchors: TREnx1VPnx2}\index{verbs-result-erg-P}
\label{E-result_P}
