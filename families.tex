...
sentences such as (\ex{0}). This tree represents the subcategorization
...
$\alpha$W1nx0Vnx1 now allows us to parse sentences such as (\ex{1}).
...
The same problem crops up in the ditranstive tree family and the
